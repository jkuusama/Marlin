...
#define STRING_CONFIG_H_AUTHOR "(JuKu for SKR 3 EZ)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 *
 * JuKu: By BTT manual, SERIAL_PORT is TFT, SERIAL_PORT_2 is USB and SERIAL_PORT_3 is WiFi
 */
#define SERIAL_PORT 1    // Need to define this anyway
 ...
 */
#define BAUDRATE 1000000    // No TFT, and USB baud rate doesn't matter, it is USB native anyways
...
#define CUSTOM_MACHINE_NAME "LitePlacer"
...
#pragma region  // extruders, hotends etc, cont.
...
#pragma endregion //  extruders, hotends etc, cont.
...
#pragma endregion // Thermals

#pragma region // Mechanical Settings (other than regular XY)
//===========================================================================
//============================= Mechanical Settings =========================
//===========================================================================
...
#pragma endregion // Mechanical Settings (other than regular XY)
