...
#define NO_CONFIGURATION_EMBEDDING_WARNING    // to supress compilation warning on debug conf builds 
 ...
 */
#define THERMOCOUPLE_MAX_ERRORS 0  // 0 to find config errors; there is no temp control
...
#pragma endregion // Thermal Settings
 ...
 * For now, doesn't work on SKR 3. See
 * https://github.com/MarlinFirmware/Marlin/issues/24730
 */
//#define NO_SD_HOST_DRIVE   // Disable SD Card access over USB (for security).

#pragma region // Additional options for Graphical Displays
/**
...
#endif
#pragma endregion // Additional options for Graphical Displays
 ...
 */
  ...
  #define HOLD_MULTIPLIER    0.3  // Scales down the holding current from run current
   #define _RSENSE    0.075       // for EZ5160
  // Override currents with M906
  // Note here: very small default currents -JuKu
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       100        // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  X_CURRENT  // (mA) RMS current for sensorless homing
    #define X_MICROSTEPS     16        // 0..256
    #define X_RSENSE          _RSENSE  // Multiplied x1000 for TMC26X
    ...
    #define Y_CURRENT       100
    #define Y_CURRENT_HOME  Y_CURRENT
    #define Y_MICROSTEPS     16
    #define Y_RSENSE          _RSENSE
    ...
    #define Z_CURRENT       100
    #define Z_CURRENT_HOME  Z_CURRENT
    #define Z_MICROSTEPS     16
    #define Z_RSENSE         _RSENSE
  ...
  #define DIAG_JUMPERS_REMOVED  // Must be defined to suppress warning, if SENSORLESS_HOMING is disabled
 ...
 */
#define STARTUP_COMMANDS "M118 Marlin_start"
...
#endif
#pragma endregion // multi-materia
